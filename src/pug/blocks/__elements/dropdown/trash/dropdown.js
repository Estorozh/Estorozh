// const dropSelection = document.querySelector('.drop-down__selection')

// dropSelection.addEventListener('click', () => {
//   const dropMenu    = document.querySelector('.drop-down__menu')
//   const dropMarker  = document.querySelector('.drop-down__mark')
  
//   dropMenu.classList.toggle('drop-down__menu_open')
  
//   if (dropMenu.classList.contains('drop-down__menu_open')) {
//     dropMarker.textContent = '-'
//   } else {
//     dropMarker.textContent = '+' 
//   }
